...
#     os.system('screen -d -m ipython ag6_calc_cmip6_grow_ef_trends.py %s'%(model))
#     os.system('screen -d -m ipython ag6_calc_cmip6_grow_pr_trends.py %s'%(model))
#     os.system('screen -d -m ipython ag6_calc_yearly_grow_cmip6_bias.py %s'%(model))
#     os.system('screen -d -m ipython ag6_calc_yearly_grow_cmip6_cpc_temp_bias.py %s'%(model))
...
#     os.system('screen -d -m ipython ag6_extract_cmip6_grow_temp.py %s'%(model))
#     os.system('screen -d -m ipython ag6_extract_cmip6_grow_pr.py %s'%(model))
